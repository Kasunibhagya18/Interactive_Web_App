...
function submitContactForm(event) {
    ...
    if (!name || !email || !subject || !message) {
        ...
        document.getElementById("successMessage").classList.replace("alert-success", "alert-danger");
        document.getElementById("successMessage").innerHTML = "Please fill all fields!";
        return;
    }
